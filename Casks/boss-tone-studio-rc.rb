cask "boss-tone-studio-rc" do
  ...
  # static.roland.com/ was verified as official when first introduced to the cask
  url "https://static.roland.com/assets/media/zip/bts_rc_m#{version.no_dots}.zip", verified: "static.roland.com/"
